...
gulp.task('clean-copy', (cb)  => {
	del(['apps/ng-softilys/src/assets/sof-images', 'apps/ng-softilys/src/assets/sof-fonts']); cb();
});

gulp.task('copy-assets', gulp.series(['clean-copy', 'copy-images', 'copy-fonts'], (done) => {
    console.log("Gulp is running...");
    done();
}));